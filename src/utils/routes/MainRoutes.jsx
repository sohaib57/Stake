...
const MainRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/sports/electronic-leagues" element={<ElectronicsLeague />} />
      ...
      <Route path="/sports/politics-entertainment" element={<PoliticsEntertainment />} />
      ...
      <Route path="/blog/category/how-to-guides" element={<HowToGuideBlogs />} />
