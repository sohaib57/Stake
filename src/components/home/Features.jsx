        ...
        <Stack width={'100%'} margin={'0px !important'}  >
            <Stack p={{ base: '4', lg: '10' }} spacing={'4'} color='#b1bad3' >
                <Stack direction={{ base: 'column', md: 'row' }} justifyContent={'space-between'} spacing={{ base: '6', lg: '0' }}  >
                    ...
                    <Stack height={'full'} width={{ base: '100%', md: '48%' }}>
                        ...
                        <Text height={'120px'} >
                            Browse our giant range of casino games as Stake offers a fair and fun online gambling experience. Play Slots, Live Casino, Blackjack, Baccarat, Roulette, and thousands of classic casino games right from your browser, including your favourite Stake Originals.
                        </Text>
                    ...
                    <Stack height={'full'} width={{ base: '100%', md: '48%' }} >
                        ...
                        <Text height={'120px'} >
                            Bet on your favourite teams, players and leagues from all around the world on our sports betting platform. Gamble on a wide range of sports betting options and markets for live sports across MMA, Basketball, Soccer and more for an unbeatable sports betting experience.
                        </Text>
                ...
                <Stack bg={'#0f212e'} height={'80px'} >
                    ...
                    <Stack px={'2'} direction={{ base: 'row-reverse', lg: 'row' }} height={'80px'} justifyContent={'space-between'} >
                        <Center >
                            <Button bg={'#3D5564'} >
                                Learn More
                            </Button>
                        ...
                        <Stack margin={'0px !important'} display={{ base: 'none', lg: 'flex' }}  >
            ...
            <Stack bg={'#0f212e'} width={'100%'} px={'10'} py={'5'} >
                ...
                <Stack direction={{ base: 'column', lg: 'row' }} justifyContent={'space-between'} >
                    ...
                    <Center>
                        <Stack spacing={'8'} direction={{ base: 'column', lg: 'row' }} margin={'0px !important'}  >
