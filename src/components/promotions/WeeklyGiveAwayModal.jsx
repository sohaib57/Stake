          ...
          <TabPanel color={'white'} padding={'0px !important'}>
            <VStack spacing={'5'} py={'5'}>
              ...
              <Text textAlign={'center'} color={'#a5afc7'}>
                ...
                Just one ticket could see you sharing in $50,000 every single
                week. With $1,000 wagered equating to one ticket, earn as many
                tickets as possible to give yourself the best chance of winning
                big! Winners drawn on live stream every Saturday 2:00pm GMT at
                www.Dlive.tv/PrimeEdd
              </Text>

              <Text color={'#a5afc7'}>
                Your number of enteries:
                <Text display={'inline'} color="#FFFFFF !important">
                  {' '}
                  0{' '}
                </Text>
              </Text>
              ...
              <Text textAlign={'center'} color={'#a5afc7'}>
                For a detailed breakdown of the prize and payout structure,
                please visit the official announcement for
                <chakra.span
                  pl="1"
                  color={'white'}
                  margin={'0 !important'}
