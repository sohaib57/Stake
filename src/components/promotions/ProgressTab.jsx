...
const ProgressTab = () => {
  return (
    <Stack width={'100%'} spacing={'5'} py={'5'}>
      ...
      <Text color={'#b1bad3'}>
        Your progress is a sum accumulated through your wager on both our casino
        and sportsbook. Increasing through the tiers entitles you to bigger
        rewards and exclusive VIP treatment.
      </Text>
      ...
      >
        <Text color={'#b1bad3'}>
          All bets settled on the sportsbook return a 3x (three times) faster
          rate of progression. Voided bets are excluded.
        </Text>
      </Stack>
    </Stack>
  );
