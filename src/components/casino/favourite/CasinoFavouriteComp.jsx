        ...
        >
          <Tabs variant="soft-rounded">
            ...
            <TabPanels>
              ...
              {/* Races */}
              <TabPanel>
                <Stack direction={'row'} justify={'space-between'} borderBottom={'2px solid #213743'} pb={'4'}>
                  <Stack color={'#B1BAD3'} direction={{base:'column', sm: 'row'}} align={'center'}>
                    <BiTimer size={'1.3rem'} />
                    <Text fontWeight={'bold'} color={'white'}>$100k Race - 24 Hours</Text>
                  </Stack>
                  <Stack color={'#B1BAD3'} direction={{base:'column', sm: 'row'}} align={'center'}>
                    <TiChartLineOutline size={'1.3rem'} />
                    <Text fontWeight={'bold'} color={'white'}>Ends in 9 hours</Text>
                  </Stack>
                </Stack>
                <TableContainer>
                        ...
                        <Tr >
                          ...
                          <Th bgColor={'#1A2C38'} isNumeric>
                            <Stack direction={'row'} color={'#4A6377'}>
                              <Tooltip placement='top' label="Your Wage for all currencies is normalised to the race currency">
                                <FaInfoCircle size={'1.1rem'} />
                              </Tooltip>
                              <Text color={'white'}>Wagered</Text>
                            </Stack>
                          </Th>
                          <Th bgColor={'#1A2C38'} isNumeric>Prize</Th>
                        </Tr>
                      </Thead>
                      <Tbody >
                        <Tr >
                          <Td >
                            <Stack direction={'row'} align={'center'}>
                              <Text>1st</Text>
                              <Tooltip placement='top' label={'This user has privacy enabled'}>
                                <Stack direction={'row'} align={'center'}>
                                  <RiSpyFill />
                                  <Text>Hidden</Text>
                                </Stack>
                          ...
                          <Td isNumeric>
                            <Stack direction={'row'} color={'#6CDE07'} align={'center'}>
