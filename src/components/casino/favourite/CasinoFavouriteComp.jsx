import { Heading, Input, InputGroup, InputLeftElement, Stack, Text, chakra, Tabs, TabList, Tab, TabPanels, TabPanel, HStack, TableContainer, Thead, Tr, Th, Tbody, Td, Tfoot, Box } from '@chakra-ui/react'
...
const CasinoFavouriteComp = () => {
    return (
        <LayoutComp>
            ...
            {/* Body Section */}
            <Stack w={'100%'} bgColor={'#1A2C38'} px={'6'} marginTop={'0px !Important'}>
                <Stack py={'6'}>
                    {/* Search Section */}
