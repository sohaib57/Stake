      ...
      <Stack pt={'8'} className="tabs">
        <Tabs variant="soft-rounded" colorScheme="green">
          ...
          <TabPanels>
            ...
            <TabPanel className="live-casino"></TabPanel>
            <TabPanel className="featured-slots"></TabPanel>
            <TabPanel className="game-shows"></TabPanel>
            <TabPanel className="stake-originals"></TabPanel>
          </TabPanels>
        </Tabs>
      </Stack>
    </Stack>
